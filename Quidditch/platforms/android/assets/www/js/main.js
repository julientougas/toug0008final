...
let setIcons = function () {
 ...
 //   games.forEach(function (value) {
        if (games[i2].classList[2] == "Gryffindor") {
            let gryff = document.createElement("div");
            gryff.classList.add("gryff");
            games[i2].appendChild(gryff);
        }
        if (games[i2].classList[2] == "Slytherin") {
            let slyth = document.createElement("div");
            slyth.classList.add("slyth");
            games[i2].appendChild(slyth);
        }
        if (games[i2].classList[2] == "Hufflepuff") {
            let huff = document.createElement("div");
            huff.classList.add("huff");
            games[i2].appendChild(huff);
        }
        if (games[i2].classList[2] == "Ravenclaw") {
            let rave = document.createElement("div");
            rave.classList.add("rave");
            games[i2].appendChild(rave);
        }
        //
        if (games[i2].classList[3] == "Gryffindor") {
            let gryff = document.createElement("div");
            gryff.classList.add("gryff");
            games[i2].appendChild(gryff);
        }
        if (games[i2].classList[3] == "Slytherin") {
            let slyth = document.createElement("div");
            slyth.classList.add("slyth");
            games[i2].appendChild(slyth);
        }
        if (games[i2].classList[3] == "Hufflepuff") {
            let huff = document.createElement("div");
            huff.classList.add("huff");
            games[i2].appendChild(huff);
        }
        if (games[i2].classList[3] == "Ravenclaw") {
            let rave = document.createElement("div");
            rave.classList.add("rave");
            games[i2].appendChild(rave);
        }
    ...
    for(let j2 = 0; j2 < teamName.length; j2++) {
   // teamName.forEach(function (item) {
        if (teamName[j2].classList.contains("Gryffindor")) {
            let gryffi = document.createElement("div");
            console.log(gryffi);
            gryffi.classList.add("gryff");
            teamName[j2].appendChild(gryffi);
        }
        if (teamName[j2].classList.contains("Slytherin")) {
            let slythi = document.createElement("div");
            slythi.classList.add("slyth");
            teamName[j2].appendChild(slythi);
        }
        if (teamName[j2].classList.contains("Hufflepuff")) {
            let huffi = document.createElement("div");
            huffi.classList.add("huff");
            teamName[j2].appendChild(huffi);
        }
        if (teamName[j2].classList.contains("Ravenclaw")) {
            let ravei = document.createElement("div");
            ravei.classList.add("rave");
            teamName[j2].appendChild(ravei);
        }
    };
};
//Fetch
